...
exports.MASTER_PROMPT = exports.PRODUCT_IMAGE_PROMPT_VERSION = void 0;
exports.buildProductImagePrompt = buildProductImagePrompt;
...
exports.PRODUCT_IMAGE_PROMPT_VERSION = "v1.0";
...
exports.MASTER_PROMPT = `You are editing a real product photograph for a professional e-commerce catalog.
...
const IMAGE_TYPE_ADDITIONS = {
    OPEN_LAPTOP_SCREEN_ON: "The laptop screen is ON in the source photo. Preserve the fact that it is genuinely displaying content — keep the same operating system, wallpaper, and on-screen elements exactly as shown. Do not invent a different desktop or interface. You may improve screen readability (glare, exposure) without changing what is actually displayed.",
    OPEN_LAPTOP_SCREEN_OFF: "The laptop screen is OFF in the source photo — it is a dark/black display. Preserve it as an off screen. Do not turn it on, and do not invent any screen content.",
    CLOSED_LAPTOP_FRONT: "The laptop is CLOSED in the source photo. Keep it closed. Do not open it or reveal the keyboard/screen.",
    CLOSED_LAPTOP_BACK: "This is a closed laptop's REAR view. Keep it closed and keep this rear-facing angle. Preserve all vents, hinges, rear ports and labels exactly.",
    SIDE_VIEW: "This is a SIDE profile view of the laptop. Keep this exact side-on angle — do not rotate the product to a front or angled view.",
    KEYBOARD_CLOSEUP: "This is a close-up of the keyboard. Preserve the exact key layout, key labels, and trackpad/TrackPoint exactly as shown — do not redesign or relabel any keys.",
    SCREEN_CLOSEUP: "This is a close-up of the screen/display. Preserve the exact bezel and any visible screen content exactly as shown — do not invent additional content.",
    OTHER_PRODUCT_VIEW: "Preserve the exact viewing angle and framing shown in the source photo. Do not change the physical perspective.",
};
function buildProductImagePrompt(imageType) {
    return `${exports.MASTER_PROMPT}\n\n${IMAGE_TYPE_ADDITIONS[imageType]}`;
}
