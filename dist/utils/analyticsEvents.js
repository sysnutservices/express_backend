...
exports.ALLOWED_EVENTS = void 0;
exports.isAllowedEvent = isAllowedEvent;
...
function isAllowedEvent(name) {
    return typeof name === "string" && exports.ALLOWED_EVENTS.includes(name);
}
